(
	...
	EventFour = function(currentGame){
	    this.game = game;
	    game = currentGame;
	};
    ...
    game.load.image('background','Event4/image/lvl4background1024x768.png');
    game.load.image('player','Event4/image/phaser-dude.png');
	game.load.image('mushroom', 'Event4/image/sprites/maggot.png');
